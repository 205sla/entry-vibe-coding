...
블록/이미지가 뒤섞인다. [`entryjs/src/class/container.js:285`](../../../upstream/entryjs/src/class/container.js#L285).
...
Entry의 클릭 처리는 [`entity.js:90`](../../../upstream/entryjs/src/class/entity.js#L90)에서
`Entry.dispatchEvent('entityClick', this.entity)` 한 줄로 이벤트 버스에 쏜다.
`when_object_click` 트리거는 이 이벤트를 구독
([`block_start.js:229`](../../../upstream/entryjs/src/playground/blocks/block_start.js#L229)).
