...
| 항목 | 출처 |
|------|------|
| Starter (`Entry.loadProject()` no-args) scene id가 `'7dwq'` | [`entryjs/src/class/project.js:82`](../../../upstream/entryjs/src/class/project.js#L82) 소스 — 공식 typedef에는 언급 없음. 사용자 `.ent` 측은 임의 id 가능 (`clearProject` 선행 전제) |
